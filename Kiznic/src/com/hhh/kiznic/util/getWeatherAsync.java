...
public class getWeatherAsync extends AsyncTask<String, Integer, String> {
	...
	public getWeatherAsync(Context mContext, LocationHelper location, TextView weather_mylocation, TextView weather_today_timedesc,  
	...
	protected void onPostExecute(String result) {
		...
		weather_image.setImageBitmap(util.setWeatherImage(mContext, weatherInfo.get(0).getWeatherDesc()));
		weather_next_image.setImageBitmap(util.setWeatherImage(mContext, weatherInfo.get(1).getWeatherDesc()));
